...
namespace TerrafirmaSceneries.Common
{
    public struct Ember
    {
        ...
        public void Update() 
        {
            ...
            Position += (Main.screenLastPosition - Main.screenPosition) * (0.5f + Parallax);
    ...
    public class EmberEffect : ModSystem
    {
        ...
        {
            if (Main.LocalPlayer.position.Y > (Main.UnderworldLayer - 40) * 16 || Main.LocalPlayer.ZoneMeteor)
            {
                Ember.Opacity += 0.02f;
            }
            else
